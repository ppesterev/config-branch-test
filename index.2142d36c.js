...
const getSettings = (url)=>fetch(url).then((res)=>res.json()
    ).catch((err)=>({
            error: err
        })
    )
...
window.addEventListener("DOMContentLoaded", ()=>{
    ...
    getSettings(_config.CONFIG_URL).then((settings)=>{
...
parcelHelpers.export(exports, "CONFIG_URL", ()=>CONFIG_URL
);
const CONFIG_URL = "https://raw.githubusercontent.com/ppesterev/config-branch-test/config/config.json";
...
},{}]},["5tOvd","3L8AI"], "3L8AI", "parcelRequire7c4b")
